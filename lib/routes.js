...
Router.route('/account/product/:id/:section',function(){
  ...
  switch(section){
    case 'basic':
      return this.render('productFirstForm',{to : 'section', data : { post : post} });
    break;
    case 'priceInfo':
      return this.render('productSecondForm',{to : 'section', data : { post : post} });
    break;
    case 'photos':
      return this.render('productThirdForm',{to : 'section', data : { post : post} });
    break;
  }
});
...
Router.route('/account/service/:id/:section',function(){
  ...
  switch(section){
    case 'basic':
      return this.render('serviceFirstForm',{to : 'section', data : { post : post} });
    break;
    case 'priceInfo':
      return this.render('serviceSecondForm',{to : 'section', data : { post : post} });
    break;
    case 'extraInfo':
      return this.render('productThirdForm',{to : 'section', data : { post : post} });
    break;
...
Router.route('/post/:id',function(){
  ...
  if(post)Meteor.subscribe('userProf',post.user);
